/* 3D-Printer Control Center - HACS Release 5.0.0-alpha20.2*/
(() => {
  const VERSION = "5.0.0-alpha20.2";
...
/* v5 alpha20.2 emergency fallback: keep Studio route loadable while the v5 Studio frontend is rebuilt. */
(() => {
  const VERSION_FALLBACK = "5.0.0-alpha20.2";
      ...
      this.shadowRoot.innerHTML = `
        <ha-card>
          <div style="padding:16px">
            ...
            <p>v5 Studio backend is deployed, but the experimental Studio frontend is temporarily held back by the alpha20.2 emergency frontend hotfix.</p>
            <p>Version: ${VERSION_FALLBACK}</p>
            <p>Real slicing and direct printing remain disabled.</p>
          </div>
        </ha-card>
      `;
    }
